          ...
          <form onSubmit={handleSubmit}>
              ...
              <div className="account-type-toggle">
                <label className={`account-option ${formData.accountType === 'tenant' ? 'active' : ''}`}>
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <span><img src="/tenant.png" alt="tenant" style={{ width: '20px', height: '20px', marginRight: '4px' }} /> Tenant (ভাড়াটিয়া)</span>
                </label>
                <label className={`account-option ${formData.accountType === 'owner' ? 'active' : ''}`}>
                  <input
                    ...
                    onChange={handleChange}
                  />
                  <span><img src="/owner.png" alt="owner" style={{ width: '20px', height: '20px', marginRight: '4px' }} /> Owner (বাড়িওয়ালা)</span>
                </label>
              </div>
            </div>
            ...
            <div className="form-group">
              ...
              <div className="toggle-buttons">
                ...
                >
                  <img src="/email.png" alt="email" style={{ width: '20px', height: '20px', marginRight: '4px' }} /> Email
                </button>
                <button
                  type="button"
                  className={`toggle-btn ${!formData.useEmail ? 'active' : ''}`}
                  onClick={handleToggle}
                >
                  <img src="/mobile.png" alt="mobile" style={{ width: '20px', height: '20px', marginRight: '4px' }} /> Mobile
                </button>
              </div>
            </div>
