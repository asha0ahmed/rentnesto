            ...
            <div className="title-section">
              <div>
                ...
                <p className="location">
                  <img src="/location.png" alt="location" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.location.address}, {property.location.area}, {property.location.district}
                </p>
              </div>
            ...
            <div className="quick-info">
              ...
              {property.features.bedrooms && (
                <div className="info-item">
                  ...
                  <span className="info-value"><img src="/bed.png" alt="bed" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.features.bedrooms}</span>
                </div>
              )}
              {property.features.bathrooms && (
                <div className="info-item">
                  <span className="info-label">Bathrooms</span>
                  <span className="info-value"><img src="/bath.png" alt="bath" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.features.bathrooms}</span>
                </div>
              )}
              {property.features.size?.value && (
                <div className="info-item">
                  <span className="info-label">Size</span>
                  <span className="info-value"><img src="/area.png" alt="size" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.features.size.value} {property.features.size.unit}</span>
                </div>
              )}
              ...
              <div className="contact-info">
                ...
                <div className="contact-item">
                  ...
                  <a href={`tel:${property.contact.phone}`} className="contact-value phone-link">
                    <img src="/phone.png" alt="phone" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.contact.phone}
                  </a>
                </div>
                ...
                {property.contact.email && (
                  <div className="contact-item">
                    ...
                    <a href={`mailto:${property.contact.email}`} className="contact-value email-link">
                      <img src="/email.png" alt="email" style={{ width: '16px', height: '16px', marginRight: '4px' }} /> {property.contact.email}
                    </a>
                  </div>
                )}
              </div>
