        ...
        <div className="results-section">
          {loading ? (
            ...
            <div className="empty-state">
              <div className="empty-icon"><img src="/house.png" alt="house Logo" style={{ width: '120px', height: 'auto', opacity: 1 }} /></div>
    ...
    <Link to={`/properties/${property._id}`} className="property-card">
      ...
      <div className="property-info">
        ...
        <div className="property-location">
          <img src="/location.png" alt="location" style={{width: '16px', height: '16px', marginRight: '4px'}} /> {property.location.area}, {property.location.district}
        </div>

        <div className="property-features">
          {property.features.bedrooms && (
            <span><img src="/bed.png" alt="bed" style={{width: '16px', height: '16px', marginRight: '4px'}} /> {property.features.bedrooms} Bed</span>
          )}
          {property.features.bathrooms && (
            <span><img src="/bath.png" alt="bath" style={{width: '16px', height: '16px', marginRight: '4px'}} /> {property.features.bathrooms} Bath</span>
          )}
          {property.features.size?.value && (
            <span><img src="/area.png" alt="size" style={{width: '16px', height: '16px', marginRight: '4px'}} /> {property.features.size.value} {property.features.size.unit}</span>
          )}
        </div>
